...
#AutoIt3Wrapper_Res_Fileversion=1.0.0.543
#AutoIt3Wrapper_Res_Fileversion_AutoIncrement=y
#AutoIt3Wrapper_Res_ProductVersion=1.0.0
#AutoIt3Wrapper_Res_LegalCopyright=By Marcelo Saied
#AutoIt3Wrapper_Res_Language=1033
#AutoIt3Wrapper_Res_Field=Productname|FileGodMode Updater
...
;~ 	$FGMshare="\\10.11.100.44\share\FGM\Prod\FileGodMode.exe"
...
#region Update
	#region check version
		...
		ConsoleWrite('@@ Debug(' & @ScriptLineNumber & ') : $tempdir & "\temp.tgm" = ' & $tempdir & "\temp.tgm" & @crlf )
		$line = FileReadLine($handle_read , 1)
		ConsoleWrite('@@ Debug(' & @ScriptLineNumber & ') : $line = ' & $line & @crlf )
		FileClose($handle_read)


Local $file = FileOpen($tempdir & "\temp.tgm", 0)
;~ While 1
...
FileClose($handle_read)
		...
		If $versionpath="" then
			...
			exit
		EndIf
		$versionpath="http://"&$WebServiceaddr&"/prod/"&$scriptname
...
;~ 				GUICtrlSetState($buttonupdate,$GUI_ENABLE)
	...
	Func _CheckNewVersion()
			$sURL="Http://" & $WebServiceaddr & "/?VPROD=T"
